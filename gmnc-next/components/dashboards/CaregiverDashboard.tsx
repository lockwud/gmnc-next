    ...
    <div className="space-y-8 pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
         ...
         <div className="lg:col-span-4 space-y-6">
            <Card className="p-8 rounded-[2.5rem] border-none shadow-sm bg-accent text-white overflow-hidden relative">
               <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-16 -mt-16 blur-2xl" />
               <div className="relative z-10 space-y-6">
                  <div className="flex items-center justify-between">
                     <GiftIcon size={32} />
                     <Badge className="bg-white/20 text-white border-none font-bold">NEW</Badge>
                  </div>
                  <div>
                     <h4 className="text-2xl font-extrabold">Refer & Earn</h4>
                     <p className="text-white/70 text-sm mt-2">Invite other parents and get GH₵ 50 in clinic rewards.</p>
                  </div>
                  <Button variant="outline" className="w-full bg-white/10 border-white/20 text-white hover:bg-white hover:text-accent font-bold py-6 rounded-2xl">
                     Get Referral Link
                  </Button>
               </div>
            </Card>
