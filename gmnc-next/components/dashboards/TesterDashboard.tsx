...
import { SYSTEM_STATUS, AUDIT_LOGS } from '@/lib/data/mockData';
    ...
    <div className="space-y-8 pb-10">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="px-4 py-2 bg-emerald-600 text-white rounded-xl text-[10px] font-bold uppercase tracking-widest shadow-lg shadow-emerald-500/20 flex items-center gap-2 hover:opacity-90 transition-all">
      ...
      <div className="pt-4">
        <Table 
          ...
          columns={[
            { header: 'ID', accessor: 'id', className: 'font-mono text-[10px] font-bold text-[#059669]' },
          ...
          actions={() => (
            <button className="text-[10px] font-extrabold text-[#059669] hover:underline uppercase tracking-widest">
               Update Status
            </button>
          )}
        />
