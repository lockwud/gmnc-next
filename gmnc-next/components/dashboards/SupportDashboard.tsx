      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            className="px-4 py-2 bg-[#059669] text-white rounded-xl text-[10px] font-bold uppercase tracking-widest shadow-lg shadow-emerald-500/20 hover:opacity-90 transition-opacity"
          >
            Manual Ticket
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-8">
          <Table
            ...
            columns={[
              { header: 'ID', accessor: 'id', className: 'font-mono text-[10px] text-[#059669] font-bold' },
