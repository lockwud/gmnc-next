        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-slate-50/50">
            {pendingProviders.map((provider) => (
              <tr key={provider.no} className="hover:bg-slate-50/30 transition-all group">
                ...
                <td className="p-6 pr-10 text-right">
                  <div className="flex justify-end gap-3">
                    <Button size="icon" variant="ghost" className="h-9 w-9 text-rose-500 bg-rose-50/30 hover:bg-rose-50 rounded-xl transition-colors">
                      <X size={18} strokeWidth={3} />
                    </Button>
                    <Button size="icon" variant="ghost" className="h-9 w-9 text-emerald-500 bg-emerald-50/50 hover:bg-emerald-100 rounded-xl transition-colors">
