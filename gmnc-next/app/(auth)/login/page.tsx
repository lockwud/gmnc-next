          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              <Input
                ...
                className="rounded-xl h-11 bg-white/50 focus:bg-white focus:ring-emerald-500/10 focus:border-emerald-500 transition-all font-medium border-0"
                required
              />
              ...
              <Select
                ...
                className="rounded-xl h-11 bg-white/50 focus:bg-white focus:ring-emerald-500/10 focus:border-emerald-500 transition-all font-medium border-0 appearance-none"
                required
              />
            </motion.div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button
                ...
                className="h-9 bg-white/40 rounded-xl hover:bg-white/60 transition-all font-bold gap-2 text-slate-600 shadow-sm text-xs border-0"
              >
